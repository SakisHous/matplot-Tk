...
class SerialCommunication:
    ...
    def __init__(self, root):
        ...
        try:
            ...
            self.gui = App(self.root, self.queue)
...
class App:
    ...
    def create_widgets(self):
        ...
        self.main_label = ttk.Entry(self.f0, font='Consolas 10', width=83)
        self.main_label.pack(side='left', fill='both', expand=1)
        self.openbtn = ttk.Button(self.f0, text='Send')
        self.openbtn.pack(side='left', fill='x', expand=0)
